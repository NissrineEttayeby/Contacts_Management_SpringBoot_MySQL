	...
	<div class="container">
		...
		<div>
			...
			<f:form action="addGroup" method="POST" modelAttribute="groupeModel">
               ...
               <div class="row">
					<div class="col">
						<label>NomGroupe</label>
						<f:input path="nomGroup" type="text" class="form-control"
							placeholder="Nom" />
						<f:errors path="nomGroup" class="text-danger" />
					</div>
			   </div>
					
					<div style="text-align: right">
					<button type="submit" class="btn btn-primary">Create</button>
					<button type="reset" class="btn btn-secondary">Exit</button>
